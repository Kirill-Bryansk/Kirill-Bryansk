# Привет! Я Кирилл Машнов 👋

## Обо мне

Я начинающий **Java-разработчик**.

Прошёл обучение в **Яндекс.Практикуме** по программе «Java-разработчик. Расширенный». Теперь хочу применить знания в коммерческой разработке.

**Что я ищу:** Стажировку, проектную работу или частичную занятость в команде, где ценят качественный код и системный подход.
...
- **Яндекс.Практикум** — Java-разработчик. Расширенный (855 часов)
    - 📜 **[Сертификат о прохождении курса](https://raw.githubusercontent.com/Kirill-Bryansk/Kirill-Bryansk/main/Диплом.pdf)**
    - Период обучения: 20.02.2025 — 22.04.2026
    - Квалификация: Developer (Программист)
...
- 📱 Telegram: [@Kirill_mashn](https://t.me/Kirill_mashn)
- 💼 VK: [vk.com/id858440212](https://vk.com/id858440212)
- 💻 GitHub: [github.com/Kirill-Bryansk](https://github.com/Kirill-Bryansk)
...
- ✅ Частичная занятость
- ✅ Проектная работа / разовые задания
- ✅ Стажировка
- 🌐 Удалённая работа
...
- Имею опыт работы со сложной технической документацией
- Быстро осваиваю новые технологии
- Навыки full-stack разработки (для учебных проектов делал и фронтенд)
