...
Java-разработчик с 15-летним инженерным бэкграундом. Прошёл обучение в **Яндекс Практикум** по программе «Java-разработчик. Расширенный». Разрабатываю бэкенд на Java + Spring, а также full-stack проекты с React.
